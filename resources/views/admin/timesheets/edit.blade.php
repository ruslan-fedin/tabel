                            ...
                            @if($stats)
                                <div class="text-xs space-y-1">
                                    <div class="flex justify-between">
                                        <span class="text-green-600">Явка:</span>
                                        <span class="font-medium">{{ $stats['Я'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-indigo-600">Центр:</span>
                                        <span class="font-medium">{{ $stats['Ц'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-blue-600">Отпуск:</span>
                                        <span class="font-medium">{{ $stats['О'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-yellow-600">Больничный:</span>
                                        <span class="font-medium">{{ $stats['Б'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-purple-600">Отгул:</span>
                                        <span class="font-medium">{{ $stats['ОТ'] }}</span>
                                    </div>
                                    <div class="flex justify-between">
                                        <span class="text-red-600">Увольнение:</span>
                                        <span class="font-medium">{{ $stats['У'] }}</span>
                                    </div>
